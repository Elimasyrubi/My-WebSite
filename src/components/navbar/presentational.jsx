		...
		return (
			<div className={css.desktopButtons}>
				<a className={
					...
					href={`
					${lenguage === 'es' ? `https://blog.eliezermasyrubi.com/wp-content/uploads/2021/06/Eliezer-Masyrubi-Frontend-Developer-y-disenador-UIUX.pdf` : ''}
            
					${lenguage === 'en' ? 'https://blog.eliezermasyrubi.com/wp-content/uploads/2021/06/EN-Eliezer-Masyrubi-Frontend-Developer-y-disenador-UIUX.pdf': ''}
					`}
					rel="noreferrer">
